...
public class ParseHtmlService
{
    ...
    public List<string> GetPublications(string html)
    {
        ...
        publicationString = publicationString.Remove(0, publicationString.IndexOf('>')); // Получаем список тегов p
        publicationString =
            new Regex(@"<b>.*</b>").Replace(publicationString,
                "")                         // выпиливаем все теги b с содержимым (в них просто дублируется автор)
