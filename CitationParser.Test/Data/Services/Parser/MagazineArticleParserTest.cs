...
public class MagazineArticleParserTest
{
    ...
    {
        var citation = " Интеллектуальная рекомендательная система для реабилитации пациентов / А.В. Заболеева-Зотова, Ю.А. Орлова, А.В. Зубков, А.Р. Донская // Искусственный интеллект и принятие решений. - 2024. - № 1. - C. 26-37. - DOI: 10.14357/20718594240103.";
